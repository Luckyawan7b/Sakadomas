...
@section('content')
    ...
    ================================================================ --}}
        <section
            ...
            <img {{-- src="{{ asset('images/auth/login-hero.jpg') }}" --}}
                ...
                alt="" class="absolute inset-0 w-full h-full object-cover opacity-80" loading="eager">
            <div class="absolute inset-0 bg-gradient-to-tr from-primary/80 via-primary/40 to-transparent mix-blend-multiply">
            </div>
            ...
            <div
                class="relative z-30 w-full max-w-2xl flex flex-col items-center text-center text-white page-enter pointer-events-auto">
    ...
    ================================================================ --}}
        <section
            class="w-full md:w-1/2 lg:w-2/5 h-full bg-surface-bright flex flex-col justify-center px-8 sm:px-16 lg:px-24 relative overflow-y-auto">
            ...
            <div class="max-w-md w-full mx-auto py-20">
                ...
                <div class="mb-12">
                    ...
                    <p class="font-manrope text-on-surface-variant/70 text-sm tracking-wide">Masukkan Username/Email dan
                        Password Anda</p>
                </div>

                {{-- ALERT SUCCESS (Misal: dari registrasi/reset password) --}}
                @if (session('success') || session('status'))
                    <div class="mb-6 flex items-center gap-2 p-4 rounded-xl bg-green-100 text-green-700 text-sm font-medium border border-green-400"
                        role="status">
                ...
                <form method="POST" action="{{ route('login.post') }}" class="space-y-6" novalidate>
                    ...
                    <div>
                        ...
                        <input id="login" type="text" name="login" value="{{ old('login') }}"
                            placeholder="Masukkan username atau email" autocomplete="username" required aria-required="true"
                    ...
                    <div>
                        ...
                        <div class="relative" x-data="{ showPassword: false }">
                            <input id="password" :type="showPassword ? 'text' : 'password'" name="password"
                                {{-- placeholder="••••••••" --}} placeholder="Masukkan kata sandi" autocomplete="current-password"
                ...
                <p class="mt-12 text-center font-manrope text-sm text-on-surface-variant">
                    ...
                    <a href="/register"
                        class="text-primary font-bold hover:underline underline-offset-4 decoration-primary/30 ml-1">
                        Registrasi
                    </a>
                </p>
            </div>
