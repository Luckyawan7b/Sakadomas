...
<head>
    ...
    <meta name="description" content="@yield('meta_description', 'Pusat pembibitan domba Crosstexel, Merino, dan kambing Etawa premium di Jember. Bersertifikat sehat, siap antar Jawa Timur.')">

    <meta property="og:type"        content="website">
    <meta property="og:url"         content="{{ url()->current() }}">
    <meta property="og:title"       content="@yield('og_title', 'Smart-Saka | Peternakan Domba & Kambing Premium')">
    <meta property="og:description" content="@yield('og_description', 'Pusat pembibitan domba premium Jember. Bersertifikat sehat, siap antar.')">
    <meta property="og:image"       content="@yield('og_image', asset(config('smartsaka.og_image', 'images/og-smart-saka.jpg')))">
    ...
    <meta name="twitter:image"       content="@yield('og_image', asset(config('smartsaka.og_image', 'images/og-smart-saka.jpg')))">
