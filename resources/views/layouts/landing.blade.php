...
<body class="relative">
    ...
    <a href="https://wa.me/{{ config('smartsaka.wa_number') }}?text={{ urlencode(config('smartsaka.wa_default_message')) }}"
        target="_blank" rel="noopener noreferrer" class="wa-float" aria-label="Hubungi kami via WhatsApp">
    ...
    <div id="toast" role="status" aria-live="polite"
        ...
        <svg id="toast-icon" class="w-5 h-5 text-olive-300 shrink-0" fill="none" stroke="currentColor"
