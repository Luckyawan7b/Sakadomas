                            ...
                            <tr class="border-b border-gray-200 dark:border-gray-800 last:border-0 hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                ...
                                <td class="py-4 px-4 text-center">
                                    <div class="flex items-center justify-center">
                                        <a href="{{ route('transaksi.detail', $transaksi->id_transaksi) ?? '#' }}" class="inline-flex items-center justify-center font-medium gap-2 rounded-lg transition px-4 py-2 text-sm bg-brand-500 text-white shadow-theme-xs hover:bg-brand-600">
