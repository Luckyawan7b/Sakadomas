            ...
            <div x-show="modalTambah" style="display: none;" class="fixed inset-0 z-[99999] flex items-center justify-center bg-black/50 px-4 py-5 backdrop-blur-sm" @click.self="modalTambah = false">
                <div class="no-scrollbar relative w-full max-w-[600px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-8" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">Ternak akan otomatis ditambahkan ke <strong>Kamar {{ $kamar->nomor_kamar }}</strong>.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('ternak.store') }}" class="flex flex-col gap-4">
                        ...
                        {{-- INPUT TERSEMBUNYI UNTUK ID KAMAR --}}
                                                ...
                                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2" x-data='{
                                                    ...
                                                    <div>
                                                        ...
                                                        <select name="id_kamar" x-model="selectedKamar" required class="dark:bg-gray-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 dark:border-gray-700 dark:text-white">
                                                            <template x-for="kamarList in kamarTersedia" :key="kamarList.id_kamar">
                                                                <option class="bg-white text-gray-800 dark:bg-gray-900 dark:text-white" :value="kamarList.id_kamar" x-text="'Kamar ' + kamarList.nomor_kamar"></option>
                                                            </template>
                                                        </select>
                                                    </div>
