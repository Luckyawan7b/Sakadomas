    ...
    <div x-data="{
        ...
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <button @click="modalFilter = true" type="button" class="relative inline-flex items-center justify-center font-medium gap-2 rounded-lg border border-gray-300 bg-white px-4 py-3 text-sm text-gray-700 shadow-theme-xs hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-white/[0.03] transition">
                ...
                <div class="no-scrollbar relative w-full max-w-[600px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-8" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100">
                    ...
                    <div class="mb-6 flex justify-between items-start">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">Tentukan kriteria ternak yang ingin ditampilkan.</p>
                        </div>
                    ...
                    <form method="GET" action="{{ route('ternak.index') }}" class="flex flex-col gap-5">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Usia Minimal (Bln)</label>
                                <input type="number" name="usia_min" value="{{ request('usia_min') }}" min='0' placeholder="0" class="dark:bg-gray-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:text-white">
                            </div>
                            <div>
                                <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Usia Maksimal (Bln)</label>
                                <input type="number" name="usia_max" value="{{ request('usia_max') }}" min='0' placeholder="Tak Terbatas" class="dark:bg-gray-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:text-white">
                            </div>
                        </div>

                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Berat Minimal (Kg)</label>
                                <input type="number" name="berat_min" value="{{ request('berat_min') }}" min="0" placeholder="0" class="dark:bg-gray-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:text-white">
                            </div>
                            <div>
                                <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Berat Maksimal (Kg)</label>
                                <input type="number" name="berat_max" value="{{ request('berat_max') }}" min="0" placeholder="Tak Terbatas" class="dark:bg-gray-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:text-white">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="status_ternak" class="dark:bg-gray-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:text-white">
                                    <option value="semua" class="bg-white text-gray-800 dark:bg-gray-900 dark:text-white" {{ request('status_ternak') == 'semua' ? 'selected' : '' }}>Semua Kondisi</option>
                                    <option value="sehat" class="bg-white text-gray-800 dark:bg-gray-900 dark:text-white" {{ request('status_ternak') == 'sehat' ? 'selected' : '' }}>Sehat</option>
                                    <option value="sakit" class="bg-white text-gray-800 dark:bg-gray-900 dark:text-white" {{ request('status_ternak') == 'sakit' ? 'selected' : '' }}>Sakit</option>
                                    <option value="hamil" class="bg-white text-gray-800 dark:bg-gray-900 dark:text-white" {{ request('status_ternak') == 'hamil' ? 'selected' : '' }}>Hamil</option>
                                </select>
                            </div>
                            <div>
                                <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Penjualan</label>
                                <select name="status_jual" class="dark:bg-gray-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:text-white">
                                    <option value="semua" class="bg-white text-gray-800 dark:bg-gray-900 dark:text-white" {{ request('status_jual') == 'semua' ? 'selected' : '' }}>Semua Status</option>
                                    <option value="tidak dijual" class="bg-white text-gray-800 dark:bg-gray-900 dark:text-white" {{ request('status_jual') == 'tidak dijual' ? 'selected' : '' }}>Tidak Dijual</option>
                                    <option value="siap jual" class="bg-white text-gray-800 dark:bg-gray-900 dark:text-white" {{ request('status_jual') == 'siap jual' ? 'selected' : '' }}>Siap Jual</option>
                                    <option value="booking" class="bg-white text-gray-800 dark:bg-gray-900 dark:text-white" {{ request('status_jual') == 'booking' ? 'selected' : '' }}>Booking</option>
                                    <option value="terjual" class="bg-white text-gray-800 dark:bg-gray-900 dark:text-white" {{ request('status_jual') == 'terjual' ? 'selected' : '' }}>Terjual</option>
                                </select>
                            </div>
                        </div>
        ...
        {{-- MODAL TAMBAH TERNAK --}}
        <template x-teleport="body">
            <div x-show="modalTambah" style="display: none;" class="fixed inset-0 z-[99999] flex items-center justify-center bg-black/50 px-4 py-5 backdrop-blur-sm" @click.self="modalTambah = false">
                <div class="no-scrollbar relative w-full max-w-[600px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-8" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100">

                    <div class="mb-6">
                        <h4 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">Registrasi Ternak Baru</h4>
                    </div>
                    ...
                    <form method="POST" action="{{ route('ternak.store') }}" class="flex flex-col gap-4">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2" x-data='{
                            ...
                            <div>
                                ...
                                <select name="id_kandang" x-model="selectedKandang" @change="selectedKamar = (selectedKandang === 'kosong' ? 'kosong' : '')" required class="dark:bg-gray-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:text-white">
                                    ...
                                    <option value="kosong" class="bg-white text-gray-800 dark:bg-gray-900 dark:text-white">Kosong</option>
                                </select>
                            </div>

                            <div>
                                <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Pilih Kamar</label>
                                <select name="id_kamar" x-model="selectedKamar" required class="dark:bg-gray-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:text-white">

                                    <option value="" disabled x-show="selectedKandang !== 'kosong'" class="bg-white text-gray-800 dark:bg-gray-900 dark:text-white">Pilih Kamar Terlebih Dahulu</option>
                            ...
                            <div>
                                <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Jenis Ternak</label>
                                <select name="id_jenis_ternak" required class="dark:bg-gray-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:text-white">
                                    <option value="" disabled selected class="bg-white text-gray-800 dark:bg-gray-900 dark:text-white">Pilih Jenis</option>
                                    @foreach($data_jenis as $jenis)
                                        <option value="{{ $jenis->id_jenis_ternak }}" class="bg-white text-gray-800 dark:bg-gray-900 dark:text-white" {{ old('id_jenis_ternak') == $jenis->id_jenis_ternak ? 'selected' : '' }}>{{ $jenis->jenis_ternak }}</option>
                                    @endforeach
                                </select>
                            </div>
        ...
        <div class="rounded-sm border border-gray-200 bg-white shadow-default dark:border-gray-800 dark:bg-gray-900 mt-6">
            <div class="py-6 px-4 md:px-6 xl:px-7.5">
                <h4 class="text-xl font-semibold text-black dark:text-white">Daftar Ternak: <span class="text-brand-500">{{ $data_ternak->total() }} Ekor Total</span></h4>
            </div>
                    ...
                    <tbody>
                        @forelse ($data_ternak as $index => $ternak)
                            <tr x-data="{
                                ...
                                <td class="py-4 px-4 text-gray-800 dark:text-gray-300">
                                    <span class="font-bold text-brand-500">Kandang {{ $ternak->kamar->kandang->nomor_kandang ?? 'kosong'}}</span><br>
                                ...
                                <td class="py-4 px-4 text-gray-800 dark:text-gray-300">
                                    <span class="font-medium capitalize">{{ $ternak->jenis_ternak->jenis_ternak ?? 'ID: '.$ternak->id_jenis_ternak }}</span><br>
                                ...
                                <template x-teleport="body">
                                    <div x-show="modalEdit" style="display: none;" class="fixed inset-0 z-[99999] flex items-center justify-center bg-black/50 px-4 py-5 backdrop-blur-sm" @click.self="modalEdit = false">
                                        <div class="no-scrollbar relative w-full max-w-[600px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-8" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100">
                                            ...
                                            <div class="mb-6 flex justify-between items-start">
                                                <div>
                                                    <h4 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">Edit Ternak #TRK-{{ $ternak->id_ternak }}</h4>
                                            ...
                                            <form method="POST" action="{{ route('ternak.update', $ternak->id_ternak) }}" class="flex flex-col gap-4">
                                                ...
                                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2" x-data='{
                                                    selectedKandang: "{{ old('id_kandang', $ternak->kamar->id_kandang ?? '') }}",
                                                    selectedKamar: "{{ old('id_kamar', $ternak->id_kamar ?? '') }}",
                                                    semuaKamar: @json($data_kamar),
                                                    get kamarTersedia() {
                                                        return this.semuaKamar.filter(k => k.id_kandang == this.selectedKandang);
                                                    }
                                                    ...
                                                    <div>
                                                        ...
                                                        <select name="id_kandang" x-model="selectedKandang" @change="selectedKamar = ''" required class="dark:bg-gray-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 dark:border-gray-700 dark:text-white">
                                                            @foreach($data_kandang as $kd)
                                                                <option value="{{ $kd->id_kandang }}" class="bg-white text-gray-800 dark:bg-gray-900 dark:text-white">Kandang {{ $kd->nomor_kandang }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div>
                                                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Jenis Ternak</label>
                                                        <select name="id_jenis_ternak" required class="dark:bg-gray-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 dark:border-gray-700 dark:text-white">
                                                            @foreach($data_jenis as $jenis)
                                                                <option value="{{ $jenis->id_jenis_ternak }}" class="bg-white text-gray-800 dark:bg-gray-900 dark:text-white" {{ $ternak->id_jenis_ternak == $jenis->id_jenis_ternak ? 'selected' : '' }}>{{ $jenis->jenis_ternak }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                ...
                                <template x-teleport="body">
                                    <div x-show="modalHapus" style="display: none;" class="fixed inset-0 z-[99999] flex items-center justify-center bg-black/50 px-4 py-5 backdrop-blur-sm" @click.self="modalHapus = false">
                                        <div class="relative w-full max-w-[400px] rounded-3xl bg-white p-6 dark:bg-gray-900 text-center" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100">
                                            ...
                                            <p class="mb-6 text-sm text-gray-500 dark:text-gray-400">Yakin ingin menghapus ternak <strong>#TRK-{{ $ternak->id_ternak }}</strong>?</p>
