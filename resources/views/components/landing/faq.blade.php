...
@php
    ...
    $items = $faqs ?? [
        [
            ...
            'answer'   => 'Pemesanan sangat mudah — cukup hubungi kami via WhatsApp di tombol yang tersedia, atau klik tombol "Pesan" pada produk yang Anda minati. Tim kami akan membantu dari proses pemilihan hewan, konfirmasi stok, hingga pengaturan pengiriman ke lokasi Anda.',
        ],
        [
            'question' => 'Apakah tersedia layanan pengiriman ke luar Jember?',
            'answer'   => 'Ya, kami melayani pengiriman ke seluruh wilayah Jawa Timur dengan kendaraan khusus ternak yang aman dan nyaman. Untuk pengiriman ke luar Jawa Timur, silakan hubungi kami terlebih dahulu untuk koordinasi lebih lanjut.',
        ],
        [
            'question' => 'Apakah hewan ternak sudah divaksinasi dan ada sertifikat kesehatannya?',
            'answer'   => 'Semua hewan di Smart-Saka menjalani vaksinasi rutin dan pemeriksaan kesehatan berkala oleh dokter hewan berpengalaman. Sertifikat kesehatan hewan dapat disediakan atas permintaan, terutama untuk pembelian dalam jumlah besar atau kebutuhan resmi.',
        ],
        [
            'question' => 'Berapa minimal pembelian dan apakah ada harga grosir?',
            'answer'   => 'Tidak ada minimal pembelian — kami melayani dari 1 ekor hingga ratusan ekor. Untuk pembelian di atas 5 ekor, kami menyediakan harga khusus. Hubungi kami untuk mendapatkan penawaran terbaik sesuai kebutuhan Anda.',
        ],
        [
            'question' => 'Bagaimana dengan layanan aqiqah dan kurban?',
            'answer'   => 'Kami menyediakan paket aqiqah dan kurban lengkap — mulai dari pemilihan hewan yang sesuai syariat, pemotongan oleh tim berpengalaman, hingga distribusi atau pengantaran daging ke lokasi yang Anda tentukan. Harga transparan dan proses amanah.',
        ],
        [
            'question' => 'Apakah tersedia konsultasi untuk pemula yang ingin mulai beternak?',
            'answer'   => 'Tentu! Kami dengan senang hati memberikan konsultasi gratis untuk siapa saja yang ingin memulai usaha ternak domba atau kambing. Tim kami akan membimbing dari pemilihan bibit, manajemen pakan, hingga pengelolaan kandang yang efisien.',
        ],
    ];
@endphp
...
<section
    id="faq"
    class="py-24 lg:py-32 bg-cream-50 relative overflow-hidden"
        ...
        <div class="grid lg:grid-cols-2 gap-6 lg:gap-10 items-start">
            ...
            >
                @foreach ($items as $i => $faq)
                    <div
                        class="bg-white rounded-2xl border border-olive-100 overflow-hidden transition-shadow hover:shadow-sm"
                        role="listitem"
                    >
                        <button
                        ...
                        >
                            <span class="font-semibold text-olive-900 text-sm leading-relaxed">{{ $faq['question'] }}</span>
            ...
            <div class="reveal-right lg:sticky lg:top-24">
                <div class="bg-olive-950 rounded-3xl p-8 lg:p-10 text-cream-50">
                    <div class="w-12 h-12 bg-olive-800 rounded-2xl flex items-center justify-center mb-6" aria-hidden="true">
                    ...
                    <p class="text-cream-300/70 text-sm leading-relaxed mb-8">
                        Tim Smart-Saka siap membantu Anda setiap hari. Konsultasi gratis, jawaban cepat, dan tidak ada pertanyaan yang terlalu kecil untuk kami.
                    </p>

                    <a
                        href="https://wa.me/{{ $waNumber }}?text={{ urlencode('Halo Smart-Saka! Saya punya pertanyaan tentang ternak Anda.') }}"
                        target="_blank"
                    ...
                    <div class="mt-6 pt-6 border-t border-olive-800 flex items-center gap-3">
                        <svg class="w-4 h-4 text-olive-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
