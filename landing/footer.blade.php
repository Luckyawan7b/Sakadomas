...
<footer id="kontak" class="bg-olive-950 text-cream-200" aria-label="Footer Smart-Saka">
    ...
    <div class="w-full relative" style="height: 360px;" aria-label="Peta lokasi Smart-Saka">
        ...
        ></iframe>
        {{-- Map overlay label --}}
        <div class="absolute top-4 left-4 z-10 bg-olive-950/90 text-cream-50 px-4 py-2.5 rounded-xl backdrop-blur-sm flex items-center gap-2 shadow-lg" aria-hidden="true">
